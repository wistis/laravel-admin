...
namespace Wistis\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Wistis\Admin\Grid grid($model, \Closure $callable)
 * @method static \Wistis\Admin\Form form($model, \Closure $callable)
 * @method static \Wistis\Admin\Show show($model, $callable = null)
 * @method static \Wistis\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Wistis\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Wistis\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Wistis\Admin\Admin::class;
    }
}
